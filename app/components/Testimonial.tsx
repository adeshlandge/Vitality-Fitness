                      ...
                      <div>
                        ...
                        <div className="mt-4">
                          ...
                          <p className="mt-4 leading-relaxed text-gray-500">
                            Simple, Personalized, and very intuitive. Great for my fitness journey!
                          </p>
                        </div>
                      </div>
                    ...
                    <blockquote className="flex h-full flex-col rounded-md border-2 border-violet-500 justify-between bg-white p-12">
                      <div>
                        ...
                        <div className="mt-4">
                          ...
                          <p className="mt-4 leading-relaxed text-gray-500">
                            Great for beginners and fitness enthusiasts. Super helpful and easy to use.
                          </p>
                        </div>
                      </div>
                    ...
                    <blockquote className="flex h-full flex-col rounded-md border-2 border-violet-500 justify-between bg-white p-12">
                      <div>
                        ...
                        <div className="mt-4">
                          ...
                          <p className="mt-4 leading-relaxed text-gray-500">
                            Diet suggestions are spot on. Feeling healthy already.
                          </p>
                        </div>
                      </div>
